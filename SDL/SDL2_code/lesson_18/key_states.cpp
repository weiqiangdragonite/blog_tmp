...
{
	/* load press texture */
	if (gPressTexture.loadFromFile("press.png") != 0) {
		fprintf(stderr, "Failed to load press texture!\n");
		return -1;
	}

	/* load up texture */
	if (gUpTexture.loadFromFile("up.png") != 0) {
		fprintf(stderr, "Failed to load up texture!\n");
		return -1;
	}

	/* load down texture */
	if (gDownTexture.loadFromFile("down.png") != 0) {
		fprintf(stderr, "Failed to load down texture!\n");
		return -1;
	}

	/* load left texture */
	if (gLeftTexture.loadFromFile("left.png") != 0) {
		fprintf(stderr, "Failed to load left texture!\n");
		return -1;
	}

	/* load right texture */
	if (gRightTexture.loadFromFile("right.png") != 0) {
