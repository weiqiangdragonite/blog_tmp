...
#define GUI_MAGENTA       0xEE00EE
#define GUI_YELLOW        0xFFFF00
#define GUI_LIGHTBLUE     0xADD8E6
#define GUI_LIGHTGREEN    0x00FF7F
#define GUI_LIGHTRED      0xFF4500
#define GUI_LIGHTCYAN     0xE0FFFF
#define GUI_LIGHTMAGENTA  0xFF00FF
#define GUI_LIGHTYELLOW   0xFFFFE0
#define GUI_DARKBLUE      0x000080
#define GUI_DARKGREEN     0x006400
#define GUI_DARKRED       0x8B0000
#define GUI_DARKCYAN      0x008B8B
#define GUI_DARKMAGENTA   0x8B008B
#define GUI_DARKYELLOW    0x8B8B00
#define GUI_WHITE         0xFFFFFF
#define GUI_LIGHTGRAY     0xD3D3D3
#define GUI_GRAY          0xBEBEBE
#define GUI_DARKGRAY      0x545454
